...
class TestDeleteKeysInNestedDict(TestNestedDict):
    def test_delete_nothing(self):
        from aws_serverless_wrapper._helper.nested_dict import delete_keys_in_nested_dict
...
class TestHashDict(TestNestedDict):
    ...
    def test_unchanged_dict(self):
        ...
        reference_hash = blake2b(str.encode(dumps(reference_dict, sort_keys=True)),
                                 digest_size=environ["dict_hash_digest_size"]).hexdigest()
    ...
    def test_deleted_keys_dict(self):
        ...
        reference_hash = blake2b(str.encode(dumps(expected_dict, sort_keys=True)),
                                 digest_size=environ["dict_hash_digest_size"]).hexdigest()
