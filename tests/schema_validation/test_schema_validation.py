...
class TestSchemaValidation(TestCase):
    ...
    def test_basic_schema(self):
        ...
        test_item = load_single(f"{dirname(realpath(__file__))}/test_data/database/item_basic.json")
    ...
    def test_basic_schema_wrong_data(self):
        ...
        test_item = load_single(f"{dirname(realpath(__file__))}/test_data/database/item_basic_wrong.json")
    ...
    def test_nested_schema(self):
        ...
        test_item = load_single(f"{dirname(realpath(__file__))}/test_data/database/item_nested.json")

        schema_file = f"{dirname(realpath(__file__))}/test_data/database/schema_nested.json"
        validator = SchemaValidator(file=schema_file)
