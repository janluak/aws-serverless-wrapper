from .iot_shadow import IoTShadowStatic
...
class IoTResourceController:
    ...
    def __getitem__(self, iot_device_name: str) -> IoTShadowStatic:
    ...
    def __create_shadow_connection(self, iot_device_name: str):
        self.__iot_devices[iot_device_name] = IoTShadowStatic(iot_device_name)
