...
def create_error_log_item(exception: Exception = None, message: str = str(), event_data: dict = dict()):
    ...
    if exception:
        ...
        raised_exception_line_no = int(raised_exception_call.split(",")[1].split(" ")[-1])
